...
def main():
    ...
    parser.add_argument('--user', help='Username', required=False, default='svc-tm1-adm')
    parser.add_argument('--ssl', help='SSL', required=False, default=True, type=bool)
    parser.add_argument('--password', help='Password', required=False, default='AfG!6X8Dffbc')
